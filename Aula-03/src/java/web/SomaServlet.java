 ...
 * @author Fatec
 */
@WebServlet(name = "TabuaServlet", urlPatterns = {"/soma.html"})
public class SomaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Soma entre "+n1+" + "+n2+"</h2>");
            out.println("<hr/>");
            out.println("<h2>"+n1+" + "+n2+" = "+(n1+n2)+"</h2>");
            out.println("<hr/>");
            out.println("<form>");
            out.println("<b>Novo Valor:</b> <input type='number' name='n1' value= "+n1+" />");
            out.println(" + <input type='number' name='n2' value= "+n2+" />");
            out.println("<input type='submit' name='gerar-soma' value='Gerar'/>");
            out.println("</form>");
            out.println("<hr/>");
